<?php 
    ...
    if($_SESSION['type'] == "student"){
        if($conn->query("INSERT INTO Matches (studentId,internId,status) VALUES (".$_SESSION['id'].",".$_GET['id'].",0);") === TRUE){
    ...
    elseif($_SESSION['type'] == "company"){
        if($conn->query("UPDATE Matches SET status = 0 where matchId = ".$_GET['id'].";") === TRUE){
